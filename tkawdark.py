...
# Demontrates a "non-built-in" ttk theme called awdark
# This theme is not included in the ttkthemes module.
...
class Application(Frame):
    def __init__(self, master=None):
        ...
        # This needs the fullpath to awdark folder
        root.call('source', 'awdark/awdark.tcl')
    ...
    def create_window(self):
        ...
        btn.grid(row=0, column=0, sticky='se', padx=25)
    ...
    def create_menu(self):
        ...
        mn_help.add_command(label="GEdit Demo code", command=self.mn_help_code)
