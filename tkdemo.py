# tkdemo.py
# straight tkinter GUI no added GUI helpers
...
class Application(Frame):
    ...
    def create_widgets(self):
        ...
        lbl = Label(leftFrame, text="Panedwindow\nwith\nCombobox\nttk", bg='black',
            fg='white', anchor=E, height=5, relief=SUNKEN)
        ...
        FILE DIALOGS
        '''
        openfiles = Button(self, text = "OpenFiles", bg = "red",
            fg = "green", command = self.openfile, font = ("Arial",16))
        openfiles.grid(column = 3, row = 2)
        openfiles2 = Button(self, text = "OpenFiles2", bg = "#AAAAAA",
            fg = "green", command = self.openfile2, font = ("Arial",16))
        openfiles2.grid(column = 3, row = 3)
        openfiles3 = Button(self, text = "Ask Directory", bg = "lightyellow",
            fg = "green", command = self.openfile3)
    ...
    def openfile(self):
        ...
        '''
        f = filedialog.askopenfilenames(initialdir="/usr/local/bin")
        print(f)  # f is a list
...
#
root = Tk()
root.geometry("540x390") # WxH+left+top
root.title("Tkinter Demo No GUI modules")
